...
const ChatInput = forwardRef<HTMLDivElement, ChatInputProps>(
  ({ onMessageSend, onModelSelect, disabled = false }) => {
    ...
    return (
      <div
        className="bg-white/80 dark:bg-[#1c1c1c]/80 backdrop-blur-md border border-zinc-200/50 dark:border-zinc-700/50 shadow-2xl drop-shadow-2xl p-3 rounded-2xl w-full
          sm:rounded-2xl
